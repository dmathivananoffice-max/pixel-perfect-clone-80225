...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    roles: ["super_admin", "managing_director", "recruiter", "documentation_officer"],
  },
  {
  ...
  },
  {
    ...
    roles: ["german_trainer", "recruiter", "super_admin"],
  },
  {
    label: "Recruiter Hub",
    path: "/recruiter",
  ...
  },
  {
    ...
    roles: ["super_admin", "recruiter", "managing_director"],
  },
  {
  ...
  },
  {
    ...
    roles: ["super_admin", "managing_director", "recruiter"],
  },
];
          ...
          <div className={cn("flex items-center gap-2 overflow-hidden", !isOpen && "hidden")}>
            {isOpen && (
              <>
                ...
                <span className="font-bold text-lg whitespace-nowrap text-sidebar-primary-foreground">
                  Workforce Europe
                </span>
              </>
            )}
          </div>
          <button onClick={onToggle} className="p-1 rounded-md hover:bg-sidebar-accent">
