...
export const PRODUCTS: ProductConfig[] = [
  {
    ...
    widgets: [
      "Total Candidates",
      "Candidates by Product",
      "Total Employers",
      "Total Hospitals",
      "Total Universities",
      "Active Recruitments",
      "Active Visas",
      "Speaking Assessment Queue",
      "STI Assessment Queue",
      "Interview Queue",
      "Monthly Placements",
      "Revenue Overview",
      "AI Insights",
    ...
    charts: [
      "Product-wise Candidate Distribution",
      "Monthly Growth",
      "Visa Pipeline",
      "Placement Funnel",
      "Conversion Funnel",
